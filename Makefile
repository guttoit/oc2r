...
#	-L/usr/local/lib -lopencv_highgui -lopencv_imgcodecs -lopencv_core -lopencv_imgproc \
...
oc2r_create_chars_img: $(PSMAIN)/oc2r_create_chars_img.c
	...
	-I/usr/include -L/usr/lib -lopencv_highgui -lopencv_imgcodecs -lopencv_core \
...
oc2r: $(PSMAIN)/oc2r.c
	...
	$(POMSG)/msg_handling.o -I/usr/include -L/usr/lib -lopencv_highgui -lopencv_imgcodecs -lopencv_core \
